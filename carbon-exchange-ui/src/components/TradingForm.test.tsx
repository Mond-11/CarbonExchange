...
describe('TradingForm', () => {
    ...
    it('should render form elements', () => {
        ...
        expect(screen.getByRole('button', { name: 'PLACE BUY ORDER' })).toBeInTheDocument();
    });
    ...
    it('should change order type', () => {
        ...
        expect(sellBtn).toHaveClass('btn-danger');
        
        const buyBtn = screen.getByRole('button', { name: 'BUY' });
        fireEvent.click(buyBtn);
        expect(buyBtn).toHaveClass('btn-success');
    });
